...
const EditModal = ({ isOpen, onClose, onSave, guidInput, setGuidInput, valueInput, setValueInput, guidOutput, setGuidOutput, valueOutput, setValueOutput }) => {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full max-w-lg">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Edit Rule</h2>
                <div className="mb-4">
