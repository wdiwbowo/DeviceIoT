...
const AddDeviceTypeModal = ({ show, onClose, onAdd }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg">
                ...
                <div className="flex justify-end">
                    ...
                    <button onClick={handleAdd} className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">Add</button>
                </div>
            </div>
        </div>
    );
