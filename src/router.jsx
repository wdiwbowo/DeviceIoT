...
export const router = createBrowserRouter([
    ...
    {
        path: '/deviceType',
        element: <ProtectedRoute element={<DeviceType />} /> 
    },
    {
        path: '/company', 
    ...
    { 
        path: '/deviceAdmin', 
        element: <ProtectedRoute element={<DeviceAdmin />} /> 
    },
    { 
        path: '/pengguna', 
    ...
    { 
        path: '/laporanPetugas', 
        element: <ProtectedRoute element={<LaporanPetugas />} /> 
    },
    { 
        path: '/manajemanKonflik', 
        element: <ProtectedRoute element={<ManajemanKonflik />} />
    },
    {
        path: '/profile',
